...
<html lang="km">
  <head>
    ...
    <title>វិញ្ញាសាជីវវិទ្យា ២០២៤ - Photo View</title>
  ...
  <body>
    ...
    <div id="exam-photo" class="photo-container split-panel" style="display: flex; flex-direction: column; align-items: center; justify-content: center; height: 50vh;">
      ...
      <div style="font-size: 14px; color: #94a3b8; margin-top: 8px;">(PDF file missing: 2024.pdf)</div>
      <div class="caption">វិញ្ញាសាប្រឡងបាក់ឌុប ២០២៤</div>
    </div>
      ...
      <i class="fas fa-file-pdf" style="font-size: 48px; color: #cbd5e1; margin-bottom: 16px;"></i>
      <div style="font-size: 18px; color: #64748b; font-weight: 700;">ឯកសារមិនទាន់មាននៅឡើយទេ</div>
      <div style="font-size: 14px; color: #94a3b8; margin-top: 8px;">(PDF file missing: 2024answer.pdf)</div>
      <div class="caption">ដំណោះស្រាយលម្អិត ២០២៤</div>
    </div>
