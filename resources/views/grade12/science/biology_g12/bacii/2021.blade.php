...
<html lang="km">
  ...
  <body>
    ...
    <div class="photo-container">
      <iframe class="pdf-view" src="2021/2021.pdf#toolbar=0&navpanes=0&scrollbar=0"></iframe>
    ...
    <div id="solution-photo" class="photo-container" style="display: none;">
      <iframe class="pdf-view" src="2021/2021answer.pdf#toolbar=0&navpanes=0&scrollbar=0"></iframe>
