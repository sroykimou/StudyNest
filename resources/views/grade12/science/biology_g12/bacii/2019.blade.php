...
<html lang="km">
  ...
  <body>
    ...
    <div class="photo-container">
      <iframe class="pdf-view" src="2019/2019.pdf#toolbar=0&navpanes=0&scrollbar=0"></iframe>
    ...
    <div id="solution-photo" class="photo-container" style="display: none;">
      <iframe class="pdf-view" src="2019/2019answer.pdf#toolbar=0&navpanes=0&scrollbar=0"></iframe>
